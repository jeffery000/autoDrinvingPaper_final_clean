...
log_dir="log/5_19ep_comma_inception_2pred_test_hal_mix2/"
...
#%% 构建my model
model_inception = InceptionV3(include_top =False,input_shape=(rows,cols,channels))
x = model_inception.get_layer("mixed2").output
