...
rows = 80
channels = 3
train_dir = "E:/dateset/comma_c12_uisee_100_102_104_105_115_118_m/img"
label_dir = "E:/dateset/comma_c12_uisee_100_102_104_105_115_118_m/comma_label_ds.txt"
log_dir="log/4_26_30ep_comma_3c_kivinet_2pred_test_half/"
...
pretrained_model = "log/4_25_30ep_comma_3c_kivinet_2pred_test_half/KivlNet_part2_15_plus15.h5"
preWhiten = False
...
#               optimizer=keras.optimizers.SGD(lr=0.5*1e-4, decay=1e-6, momentum=0.9, nesterov=True),
#               metrics=['mse'])
model.compile(loss=keras.losses.MSE,
              optimizer=keras.optimizers.Adam(lr=0.4*1e-3),
              metrics=['mse'])
