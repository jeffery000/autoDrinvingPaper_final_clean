...
test_dir = "E:/dateset/selfdriving-car-simulator_Uisee1_3/img"
train_test_ratio = 5
preWhiten = False
model_name = "log/4_24ep_udacity_3c_kivinet_2pred_test_half/KivlNet_part2_25.h5"
prediction_dir = "prediction_udacity_3channel_kivinet.log"
#%% 构建my model
...
# test_read_index = [i for i in list(range(4000,5163,1))]+[i for i in list(range(8000,9000,1))]
