...
train_dir = "E:/dateset/selfdriving-car-simulator_Uisee_ds1_5/img"
label_dir = "E:/dateset/selfdriving-car-simulator_Uisee_ds1_5/action_pose.txt"
log_dir="log/3_20_50ep_udac_no_seg/"
...
pretrained_model = "log/11_24_keras/KivlNet_part2_10.h5"
preWhiten = False
...
#%% 构建my model
model = Sequential()
model.add(Conv2D(32, (5, 5),activation='relu',input_shape=(rows,cols,channels)))
