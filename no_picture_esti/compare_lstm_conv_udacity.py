...
predict_dir = "prediction_ud_5_19.log"
# predict_dir = "prediction_ud_seg_fla_5_19.log"
# predict_dir = "prediction_ud_nvnet_5_19.log"
# predict_dir = "prediction_ud_vgg_transfer_5_19.log"
# predict_dir = "prediction_ud_inception_transfer_5_19.log"
...
count_train = 0
count_test = 0
test_read_index = [i for i in list(range(6,label.shape[0]//train_test_ratio,1))]
label = label[test_read_index[2:]]
...
RMSE_angle_test,RMSE_speed_test = cal_RMSE(predict_np,label)
