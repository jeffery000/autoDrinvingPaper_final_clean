...
label_dir = "action_pose_carla_speed.txt"
epochs = 300
model_name = "lstm_model_carla.h5"
look_back = 6
train_test_ratio = 5
data_cut = False	
data_cut_num = 4350
...
if train_from_begin:
	...
	model.fit(trainX, trainY, nb_epoch=epochs, batch_size=64, validation_data = (testX,testY),verbose=2,callbacks=[TensorBoard(log_dir='run_carla')])
