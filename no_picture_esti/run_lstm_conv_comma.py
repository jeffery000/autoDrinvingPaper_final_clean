...
model_LSTM_name = "lstm_model_comma.h5"
model_CONV_name = "../log/5_19comma_vgg_fla_pw_3c_kivinet_2pred_test_half_6th/KivlNet_part2_30.h5"
test_dir = "D:/dataset/comma_c12_uisee_100_102_104_105_115_118_m/img"
vgg_cam_dir = "D:/dataset/comma_c12_uisee_100_102_104_105_115_118_m/img_vgg_cam_6th"
look_back = 6
train_test_ratio = 5
...
test_read_index = [i for i in list(range(6,len(label)//train_test_ratio,1))]
...
def extract_one_batch(list_train_index, train_dir, shape_img = [rows,cols,channels]):
    ...
    for index_file_name,file_name in enumerate(list_train_index):
        ...
        img_vgg = cv2.resize(img,(cols,rows))/255
...
predict_list = []
for batch_id in range(2,num_batch-1,1):
    file_name_current = []
    for i in range(look_back+1):
        file_name_current.append(str(test_read_index[batch_id]-look_back+i)+".jpg")
