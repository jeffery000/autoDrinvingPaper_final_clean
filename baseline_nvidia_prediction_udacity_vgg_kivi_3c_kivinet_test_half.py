...
train_test_ratio = 5
preWhiten = False
model_name = "log/5_19ep_udacity_3c_vgg_fla_pw_2pred_test_half/KivlNet_part2_22.h5"
prediction_dir = "prediction_udacity_vgg_fla_pw_3channel_kivinet_5_19.log"
#%% 构建my model
...
def extract_one_batch(list_train_index, train_dir, shape_img = [rows,cols,channels]):
    ...
    for index_file_name,file_name in enumerate(list_train_index):
        ...
        img_vgg = cv2.imread(vgg_cam_dir+"/"+file_name)/255#[:,:,0:1]/255
