...
train_test_ratio = 5
preWhiten = False
model_name = "log/5_19comma_vgg_fla_pw_3c_kivinet_2pred_test_half_6th/KivlNet_part2_30.h5"
prediction_dir = "prediction_comma_vgg_fla_pw_3channel_kivinet_5_19.log"
#%% 构建my model
