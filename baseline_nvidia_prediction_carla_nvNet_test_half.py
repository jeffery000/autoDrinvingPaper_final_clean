...
test_dir = "D:/dataset/carla527_test_train_1_3_m/img"
train_test_ratio = 5
preWhiten = False
model_name = "log/5_19ep_calar_nvNet_2pred_test_half/KivlNet_part2_30.h5"
prediction_dir = "prediction_calar_nvNet_2_pred_5_19.log"
#%% 构建my model
...
test_read_index = [i for i in list(range(0,3169,1))]#+[i for i in list(range(6000,6900,1))]
