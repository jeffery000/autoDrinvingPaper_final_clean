...
rows = 80
channels = 3
train_dir = "D:/dataset/carla527_test_train_1_3_m/img"
label_dir = "D:/dataset/carla527_test_train_1_3_m/action_pose_carla_speed.txt"
log_dir="log/5_19ep_calar_nvNet_2pred_test_half/"
...
if train_only:
    ...
    test_read_index = [i for i in list(range(0,3169,1))]
