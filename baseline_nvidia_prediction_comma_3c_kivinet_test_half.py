...
test_dir = "E:/dateset/comma_c12_uisee_100_102_104_105_115_118_m/img"
train_test_ratio = 5
preWhiten = False
model_name = "log/4_26_30ep_comma_3c_kivinet_2pred_test_half/KivlNet_part2_24.h5"
prediction_dir = "prediction_comma_3channel_kivinet.log"
#%% 构建my model
...
test_read_index = [i for i in list(range(0,num_total_file,train_test_ratio))]#+[i for i in list(range(6000,6900,1))]
