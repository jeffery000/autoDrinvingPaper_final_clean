...
train_test_ratio = 5
preWhiten = False
model_name = "log/5_19comma_seg_fla_pw_3c_kivinet_2pred_test_half/KivlNet_part2_10_10.h5"
prediction_dir = "prediction_comma_seg_fla_pw_3channel_kivinet_5_19.log"
#%% 构建my model
...
def extract_one_batch(list_train_index, train_dir, shape_img = [rows,cols,channels]):
    ...
    for index_file_name,file_name in enumerate(list_train_index):
        ...
        img_seg = cv2.imread(seg_cam_dir+"/"+str(file_name))#[:,:,0:1]/255
